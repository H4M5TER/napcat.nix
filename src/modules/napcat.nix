{ config, pkgs, lib, ... }: let
  sources = {
    ...
    napcat_version = "v4.5.22";
    napcat_url = "https://github.com/NapNeko/NapCatQQ/releases/download/v4.5.22/NapCat.Shell.zip";
    napcat_hash = "sha256-o83ivfPDhsH5IBRtuqxNvF/CE9UW30GHKfR6hyKg2TQ=";
